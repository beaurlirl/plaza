  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-4 md:p-6">
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row items-center justify-between mb-8 space-y-4 md:space-y-0">
        ...
        <h1 className="heading-lg md:heading-xl text-black">t-shirt generator</h1>
      ...
      <div 
        ...
        className="w-64 md:w-80 h-64 md:h-80 relative cursor-pointer flex items-center justify-center animate-gentle-wave glass-panel rounded-3xl"
        style={{
          background,
